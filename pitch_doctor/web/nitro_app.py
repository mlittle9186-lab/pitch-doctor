...
def nitro_write_report(*args,**kwargs):
    ...
    replacements={
        ...
        "Implementing gzip, caching, lazy loading, and modern image formats makes pages faster, saves bandwidth, and improves SEO rankings.":"Improving caching, lazy loading, compression, and image formats can make pages faster, reduce bandwidth use, and support a better search experience.",
        "Every extra second past 3 quietly costs you visitors.":"Slower first paint can increase abandonment, especially on mobile.",
        "Adding Schema.org structured data, Open Graph tags, and canonical tags improves search rankings, makes social links more attractive, and prevents duplicate content penalties.":"Adding structured data, Open Graph tags, and canonical tags helps search engines understand the site, improves social previews, and identifies the preferred URL for indexing.",
        "GOOGLE_PLACES_API_KEY is not set.":"The listing lookup was unavailable during this scan.",
        ...
        "Professional ($1,000) — make contacting and booking you effortless: tap-to-call, a short form, and an obvious next step on every page.":"Priority modernization — fix the highest-impact visibility, trust, performance, and conversion issues identified in this audit first.","Basic ($500)":"Essential fixes","Professional ($1,000)":"Priority modernization",
    }
